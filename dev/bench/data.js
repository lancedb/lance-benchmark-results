    ...
    "Lance Rust Benchmarks": [
      ...
      },
      {
        "commit": {
          ...
          "id": "d038e3412d6ecb18367f2644cfe6db35adfc50d0",
          "message": "feat: merge-insert supports inserting subset of columns (#3100)\n\nIn https://github.com/lancedb/lance/pull/2639 we added support for\n*updating* subcolumns. In https://github.com/lancedb/lance/pull/3041 we\nadded support for *inserting* subcolumns. This PR adds support for\nupserting them (or doing insert-if-not-exists).\n\nCloses #2904\n\n## Example\n\n```python\nimport pyarrow as pa\nimport lance\n\ntable = pa.table({\n    \"id\": range(3),\n    \"a\": [1.0, 2.0, 3.0],\n    \"c\": [\"x\", \"x\", \"x\"]\n})\ndataset = lance.write_dataset(table, \"example\")\n\n# Upsert: when_matched_update_all + when_not_matched_insert_all\nnew_data = pa.table({\n    \"id\": [2, 3],\n    \"c\": [\"y\", \"y\"]\n})\n(\n    dataset\n    .merge_insert(on=\"id\")\n    .when_matched_update_all()\n    .when_not_matched_insert_all()\n    .execute(new_data)\n)\ndataset.to_table().to_pandas()\n```\n```\n   id    a  c\n0   0  1.0  x\n1   1  2.0  x\n2   2  3.0  y\n3   3  NaN  y\n```\n\n```python\n# Insert-if-not-exists: when_not_matched_insert_all\nnew_data = pa.table({\n    \"id\": [3, 4],\n    \"c\": [\"z\", \"z\"]\n})\n(\n    dataset\n    .merge_insert(on=\"id\")\n    .when_not_matched_insert_all()\n    .execute(new_data)\n)\ndataset.to_table().to_pandas()\n\n   id    a  c\n0   0  1.0  x\n1   1  2.0  x\n2   2  3.0  y\n3   3  NaN  y\n4   4  NaN  z\n```",
          "timestamp": "2024-12-18T00:16:40Z",
          "url": "https://github.com/lancedb/lance/commit/d038e3412d6ecb18367f2644cfe6db35adfc50d0"
        },
        "date": 1734514606547,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "2b294872fe0dbdaaa031dba89795dac05fcbcba1",
          "message": "feat(java): support alter columns for dataset (#3259)",
          "timestamp": "2024-12-20T02:59:34Z",
          "url": "https://github.com/lancedb/lance/commit/2b294872fe0dbdaaa031dba89795dac05fcbcba1"
        },
        "date": 1734687395484,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "d06488e4f55fce092af8ae777193afcd7448ffb0",
          "message": "Bump version",
          "timestamp": "2024-12-23T23:49:56Z",
          "url": "https://github.com/lancedb/lance/commit/d06488e4f55fce092af8ae777193afcd7448ffb0"
        },
        "date": 1735033017684,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "c6fcb31ec6ca50797765420feb7fd704862de788",
          "message": "chore(java): remove some supported TODO and add allow_http for storage_option (#3288)\n\nIn this pr, I did:\r\n1. remove some supported TODOs\r\n2. add allow_http for storage_option\r\n3. remove some unused code",
          "timestamp": "2024-12-24T17:09:07Z",
          "url": "https://github.com/lancedb/lance/commit/c6fcb31ec6ca50797765420feb7fd704862de788"
        },
        "date": 1735119471886,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "bcb040ec9cbe6bc369433145c292da5fd9be918b",
          "message": "fix: fix pyproject.toml (#3299)\n\nci pipeline failed",
          "timestamp": "2024-12-26T06:29:38Z",
          "url": "https://github.com/lancedb/lance/commit/bcb040ec9cbe6bc369433145c292da5fd9be918b"
        },
        "date": 1735205958226,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "38a0a92d93b8209e8596aa2142795e2befba0516",
          "message": "feat: cache btree sub-index pages (#3309)\n\nThe btree currently only caches the the lookup. This means there will\r\nalways need to be at least one IOP per search 4Ki rows that match the\r\nfilter to load the sub-index (flat) data.\r\n\r\nThis PR adds a cache for the data pages as well.\r\n\r\nThe cache defaults to 512MiB and is technically configurable via\r\n`LANCE_BTREE_CACHE_SIZE` but this is just a stop-gap. We should ideally\r\nhave a single size limit for all scalar indices (or, even better, a\r\nsingle size limit for ALL indices). However, this is a bit tricky. I\r\ndon't think moka caches can share capacity across several caches and\r\nusing a single moka cache for all places we need cache is tricky because\r\nmoka caches are typed (in some places we use `Arc<dyn Any>` which might\r\nbe a possible solution though we still need to deal with the fact that\r\nwe key the different caches by `u32`, `String`, and\r\n`object_store::Path`).\r\n\r\nWe can resolve this technical debt in\r\nhttps://github.com/lancedb/lance/issues/3136",
          "timestamp": "2024-12-27T16:41:33Z",
          "url": "https://github.com/lancedb/lance/commit/38a0a92d93b8209e8596aa2142795e2befba0516"
        },
        "date": 1735378591984,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "7363a536416b2fdab40b64f04097c943d2b74613",
          "message": "fix: is not false crash (#3298)\n\nCo-authored-by: Will Jones <willjones127@gmail.com>",
          "timestamp": "2024-12-31T05:19:03Z",
          "url": "https://github.com/lancedb/lance/commit/7363a536416b2fdab40b64f04097c943d2b74613"
        },
        "date": 1735637859935,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "8767c102f08de80e6648268695f7b2815465d48c",
          "message": "feat(java): support take api for java module (#3316)",
          "timestamp": "2024-12-31T18:19:03Z",
          "url": "https://github.com/lancedb/lance/commit/8767c102f08de80e6648268695f7b2815465d48c"
        },
        "date": 1735724220908,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "33c45c8eb622204dbf99f82df401cf986120442f",
          "message": "feat(java): support overwrite for spark connector (#3313)\n\nsupport overwrite for lance spark connector\r\n```scala\r\ndf.write\r\n  .format(\"lance\")\r\n  .option(\"path\", \"s3://lance/demo.lance\")\r\n  .mode(\"overwrite\")\r\n  .save()\r\n```",
          "timestamp": "2025-01-01T22:02:11Z",
          "url": "https://github.com/lancedb/lance/commit/33c45c8eb622204dbf99f82df401cf986120442f"
        },
        "date": 1735810617445,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "39f12dc3af0d42d3a8ba420df42c7010babbf2e7",
          "message": "feat: vector search with distance range (#3326)",
          "timestamp": "2025-01-03T07:07:25Z",
          "url": "https://github.com/lancedb/lance/commit/39f12dc3af0d42d3a8ba420df42c7010babbf2e7"
        },
        "date": 1735897005135,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "45fde4c0bc15482d15d243e813034fa79f09d4c7",
          "message": "ci(java/scala): auto check and insert unified license header (#3296)",
          "timestamp": "2025-01-03T23:42:12Z",
          "url": "https://github.com/lancedb/lance/commit/45fde4c0bc15482d15d243e813034fa79f09d4c7"
        },
        "date": 1735983405819,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          "author": {
            "name": "huangzhaowei",
            "username": "SaintBacchus",
            "email": "huangzhaowei.416@bytedance.com"
          },
          "committer": {
            "name": "GitHub",
            "username": "web-flow",
          ...
          "id": "1d40479c1d51f634233483aa04985a6d30bb8323",
          "message": "feat(java): support get real data size for lance spark statistics interface (#3337)\n\nWith #3328, now we can calculate the dataset disk size.",
          "timestamp": "2025-01-05T05:16:27Z",
          "url": "https://github.com/lancedb/lance/commit/1d40479c1d51f634233483aa04985a6d30bb8323"
        },
        "date": 1736069787852,
        "tool": "cargo",
        "benches": [
      ...
      },
      {
        "commit": {
          ...
          "id": "f621115bc11ed94a4d25c414c680043844124341",
          "message": "feat(java): support add columns via sql expressions (#3287)",
          "timestamp": "2025-01-07T00:53:56Z",
          "url": "https://github.com/lancedb/lance/commit/f621115bc11ed94a4d25c414c680043844124341"
        },
        "date": 1736242631284,
        "tool": "cargo",
        "benches": [
